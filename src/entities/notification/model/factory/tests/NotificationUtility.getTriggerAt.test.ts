...
describe('NotificationUtility: test getTriggerAt methods with taking into account cross-day events.', () => {
  describe('Test fixed notifications', () => {
    it('Should return the day after tomorrow with set time when isNextDay parameter is false and scheduledDay is today + 2 days', () => {
    ...
    it('Should return the day after tomorrow + 1 day with set time when isNextDay parameter is true and scheduledDay is today + 2 days', () => {
      const today = new Date(2024, 0, 3);
  ...
  describe('Test random notifications', () => {
    it('Should return tomorrow with set time when both: from and to are in the current day and scheduledDay is tomorrow', () => {
      const today = new Date(2024, 0, 3);
    ...
    it('Should return tomorrow + 1 day with set time when both: from and to are in the next day and scheduledDay is tomorrow', () => {
      const today = new Date(2024, 0, 3);
